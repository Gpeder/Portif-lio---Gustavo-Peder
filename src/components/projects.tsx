            ...
            >
                <div className="flex flex-wrap gap-2 mb-8">
                    <button
                        ...
                        style={filtro === null ? { backgroundColor: 'var(--accent-soft)' } : undefined}
                    >
                        Todos
                    </button>
                    {tecnologiasUnicas.map((tech) => (
                        <button
                            ...
                            style={filtro === tech ? { backgroundColor: 'var(--accent-soft)' } : undefined}
                        >
                            {tech}
                        </button>
                    ))}
                        ...
                        return (
                            <div
                                ...
                                className={`transition-all duration-300 ${
                                    ativo ? 'opacity-100' : 'opacity-20 pointer-events-none scale-[0.98]'
                                }`}
                            >
                                <ProjectCard
                                    {...projeto}
